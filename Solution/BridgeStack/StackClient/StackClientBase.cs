...
namespace BridgeStack
{
	...
	internal abstract class StackClientBase : IStackClient
	{
		...
		protected IApiEndpointBuilder GetApiEndpointBuilder(ApiMethodEnum method, IRequestVector[] vectors = null)
		{
		...
		protected IBridgeResponseCollection<TResult> GetApiResultCollection<TResult, TQuery>(ApiMethodEnum method, TQuery parameters)
			where TResult : class
		...
		/// <param name="parameters">The query string parameters.</param>
		/// <returns>A response that comes either from the API, the internal cache, or an exception. Wrapped in a common API response object.</returns>
		protected IBridgeResponseCollection<TResult> GetApiResultCollection<TResult, TQuery>(ApiMethodEnum method, IRequestVector[] vectors, TQuery parameters)
			where TResult : class
			where TQuery : class, IQuery, new()
		{
		...
		/// <param name="parameters">The query string parameters.</param>
		/// <returns>A response that comes either from the API, the internal cache, or an exception. Wrapped in a common API response object.</returns>
		protected IBridgeResponseCollection<TResult> GetApiResultCollection<TResult, TQuery>(ApiMethodEnum method, IRequestVector vector, TQuery parameters)
			where TResult : class
			where TQuery : class, IQuery, new()
		{
		...
		/// <param name="parameters">The query string parameters.</param>
		/// <returns>A response that comes either from the API, the internal cache, or an exception. Wrapped in a common API response object.</returns>
		protected IBridgeResponseItem<TResult> GetApiResultItem<TResult, TQuery>(ApiMethodEnum method, TQuery parameters = null)
			where TResult : class
			where TQuery : class, IQuery, new()
		{
		...
		/// <param name="parameters">The query string parameters.</param>
		/// <returns>A response that comes either from the API, the internal cache, or an exception. Wrapped in a common API response object.</returns>
		protected IBridgeResponseItem<TResult> GetApiResultItem<TResult, TQuery>(ApiMethodEnum method, IRequestVector vector, TQuery parameters = null)
			where TResult : class
			where TQuery : class, IQuery, new()
		{
		...
		/// <param name="parameters">The query string parameters.</param>
		/// <returns>A response that comes either from the API, the internal cache, or an exception. Wrapped in a common API response object.</returns>
		protected IBridgeResponseItem<TResult> GetApiResultItem<TResult, TQuery>(ApiMethodEnum method, IRequestVector[] vectors, TQuery parameters = null)
			where TResult : class
			where TQuery : class, IQuery, new()
		{
