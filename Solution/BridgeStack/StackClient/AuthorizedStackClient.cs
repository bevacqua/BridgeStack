...
namespace BridgeStack
{
	internal sealed class AuthorizedStackClient : StackClient, IAuthorizedStackClient
	{
		...
		{
			return GetApiResultCollection<Event, SinceQuery>(ApiMethodEnum.Events, parameters);
		}
		...
		{
			return GetApiResultCollection<InboxItem, SinceQuery>(ApiMethodEnum.UserInboxUnread, CreateIdVector(id), parameters);
		}
		...
		{
			return GetApiResultCollection<Question, PostsQuery>(ApiMethodEnum.MyNoAnswerQuestions, parameters);
		}
		...
		{
			return GetApiResultCollection<Answer, PostsQuery>(ApiMethodEnum.MyTopAnswersInTags, CreateTagsVector(tags), parameters);
		}
		...
		{
			return GetApiResultCollection<InboxItem, SimpleQuery>(ApiMethodEnum.MyInbox, parameters);
		}
		...
		{
			return GetApiResultCollection<InboxItem, SinceQuery>(ApiMethodEnum.MyInboxUnread, parameters);
		}
