...
namespace BridgeStack
{
	...
	internal abstract class StackClientBase : IStackClient
	{
		...
		public abstract IBridgeResponseCollection<Event> GetEvents(SinceQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<InboxItem> GetUserInbox(long id, SimpleQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<InboxItem> GetUserInboxUnread(long id, SinceQuery parameters = null);
		...
		public abstract IBridgeResponseItem<User> GetMyUser(UsersQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Answer> GetMyAnswers(PostsQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Badge> GetMyBadges(BadgesOnUserQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Comment> GetMyComments(CommentsQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Comment> GetMyCommentsInReplyTo(long toId, CommentsQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Question> GetMyQuestionFavorites(QuestionFavoritesQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Comment> GetMyMentions(CommentsQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Privilege> GetMyPrivileges(SimpleQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Question> GetMyQuestions(PostsQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Question> GetMyQuestionsWithNoAnswers(PostsQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Question> GetMyQuestionsWithNoAcceptedAnswer(PostsQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Question> GetMyQuestionsConsideredUnanswered(PostsQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Reputation> GetMyReputationChanges(RangedQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<SuggestedEdit> GetMySuggestedEdits(SuggestedEditsQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Tag> GetMyActiveTags(TagsQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Answer> GetMyTopAnswers(string[] tags, PostsQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<Question> GetMyTopQuestions(string[] tags, PostsQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<UserTimeline> GetMyTimeline(RangedQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<TagTop> GetMyTopAnswerTags(SimpleQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<TagTop> GetMyTopQuestionTags(SimpleQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<InboxItem> GetMyInbox(SimpleQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<InboxItem> GetMyInboxUnread(SinceQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<NetworkUser> GetMyAssociatedAccounts(SimpleQuery parameters = null);
		...
		/// <param name="parameters">The request parameters.</param>
		/// <returns>Returns all items in a user's inbox.</returns>
		public abstract IBridgeResponseCollection<InboxItem> GetNetworkInbox(SimpleQuery parameters = null);
		...
		public abstract IBridgeResponseCollection<InboxItem> GetNetworkInboxUnread(SinceQuery parameters = null);
		...
		protected StackClientBase(IRequestHandler requestHandler, string appKey, string accessToken)
		{
		...
		{
			return new ApiEndpointBuilder(this, method, _appKey, _accessToken);
		}
